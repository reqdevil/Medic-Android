...
class MyAdapter(private val patientsList: ArrayList<Patient>) : RecyclerView.Adapter<MyAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val dataPass = itemView.context as OnDataPass
    }
...
//        }
        ...
        holder.fullNameText.text = currentItem.fullName
